...
Revision ID: 7e5b880aa82c
Revises: 
Create Date: 2024-05-03 18:46:28.185068
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['driver_id'], ['driver.id'], name=op.f('fk_ride_driver_id_driver')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('confirmed', 'pending', 'cancelled'), nullable=False),
    sa.ForeignKeyConstraint(['ride_id'], ['ride.id'], name=op.f('fk_booking_ride_id_ride')),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('ride_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['ride_id'], ['ride.id'], name=op.f('fk_review_ride_id_ride')),
